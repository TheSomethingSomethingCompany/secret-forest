...
export default function Chats() {
  return (
    <section className="m-4 mt-40 grid grid-cols-4 grid-rows-1 rounded-lg shadow-md drop-shadow-md w-screen h-full bg-purple-100">
      <div className="m-2 col-span-1 rounded-lg shadow-md drop-shadow-md flex flex-row justify-evenly bg-white h-fit">
        <div className="flex flex-row justify-between flex-1 p-4 ">
          ...
          <div className="flex flex-col flex-1 w-full items-start justify-center p-2">
            <span className="text-center">Satanshu Mishra</span>
            <span className="text-center">@CaptainMidway</span>
          </div>
        </div>
