...
function SearchBar({ searchQ, setSearchQ, searchBy, setSearchBy, onSearch }) {
	return (
		<div className="flex-1 flex flex-col lg:flex-row w-full my-2">
			<div className="flex flex-row justify-between items-center pr-4 px-4 bg-[#1F2932] rounded-lg my-2 lg:my-0 lg:mr-2">
