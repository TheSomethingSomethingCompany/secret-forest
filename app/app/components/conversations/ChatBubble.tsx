			...
			{isYou ? (
						...
						<div className="-z-10 w-full flex flex-row justify-start mx-4 -translate-y-[--translateAmt] transition-transform duration-300">
							{isEditing ? (
								...
								<>
									...
									<div
										className="p-2 hover:bg-[#1e5696] bg-[#102E51] rounded-b-lg mx-[0.3rem] text-white hover:cursor-pointer"
										onClick={() => {
											setIsEditing(false);
											setMessageText(
									...
									<div
										className="p-2 hover:bg-[#1e5696] bg-[#102E51] rounded-b-lg mx-[0.3rem] mr-4 text-white hover:cursor-pointer"
										onClick={() => {
											setIsEditing(false);
										}}
									>
								...
								<>
									<div
										className="p-2 bg-[#102E51] rounded-b-lg mx-[0.3rem] text-white hover:cursor-pointer"
									...
									<div
										className="p-2 bg-[#102E51] rounded-b-lg mx-[0.3rem] mr-4 text-white hover:cursor-pointer"
				...
				>
					...
					<div className="-z-10 w-full flex flex-row justify-end mr-8 -translate-y-[--translateAmt] transition-transform duration-300">
						<div
							className="p-2 bg-blue-600 rounded-b-lg mx-[0.3rem] text-white hover:cursor-pointer"
							onClick={onDeleteButtonClick}
							data-message-id={id}
						>
							<i className="ri-delete-bin-2-fill"></i>
