        ...
        <form action="" method="post" className="relative overflow-y-auto w-full h-screen overflow-y-auto bg-gradient-to-r from-blue-500 to-green-500" onSubmit={handleSubmit}>
                ...
                <div className = "flex items-center flex-col-reverse w-screen h-[100vh]">
                    <div id = "labels-and-inputs-container" className = "flex h-[100vh] w-1/2 flex-col items-center p-2"> {/* Ensures the labels div and the inputs div are side-by-side */}
                        <div className = "w-full mb-10 mt-20 flex justify-center"><h1 className = "font-semibold mobile:text-[5vw] tablet:text-[4rem] desktop:text-[4rem]">Create Your Profile</h1> </div>

                            <div id = "pfp-container" className = "w-1/2 flex flex-col items-center"> {/* On mobile, having this here will ensure it does not take up the full height */}
